...
public class ChooseBreathRecycleViewAdapter extends RecyclerView.Adapter<ChooseExerciseViewHolder>{
    List<BreathRealmObject> objectList = RealmHandler.getInstance().getListBreathObjectFromRealm();
    ...
    public void onBindViewHolder(ChooseExerciseViewHolder holder, int position) {
        ...
        holder.setDataBreath( objectList.get(position));
